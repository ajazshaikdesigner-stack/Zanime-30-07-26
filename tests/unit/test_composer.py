...
from src.models.composer_model import ComposerObject, ComposerShot, LayerType


def test_scene_validator():
    shot = ComposerShot()
    obj1 = ComposerObject(
        name="Hero", x=0, y=0, visible=True, layer=LayerType.CHARACTERS
    )
    ...
    obj2 = ComposerObject(
        name="Prop", x=9999, y=0, visible=False, layer=LayerType.BACKGROUND
    )
