import pytest
from src.models.voice_model import VoiceTimeline, VoiceTrack, DialogueClip
...
def test_voice_validator():
    ...
    # Valid clip
    clip1 = DialogueClip(text="Hello!", voice_profile_uuid="123", start_frame=0, duration=24)
    
    # Overlapping clip
    clip2 = DialogueClip(text="Wait!", voice_profile_uuid="123", start_frame=12, duration=24)
