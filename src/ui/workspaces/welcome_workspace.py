...
from PySide6.QtWidgets import (
    ...
    QLineEdit, QScrollArea, QMessageBox, QSpacerItem, QSizePolicy, QPushButton
)
from PySide6.QtCore import Qt
from src.ui.widgets.welcome_cards import QuickActionButton, ProjectCard, DemoProjectCard

logger = logging.getLogger(__name__)

MOCK_PROJECTS = [
    {"name": "Hero Character Setup", "modified": "Today", "version": "1.0", "size": "45MB", "pinned": True},
    {"name": "City Background Night", "modified": "Yesterday", "version": "0.9", "size": "120MB", "pinned": True},
    {"name": "Fight Scene Rough", "modified": "3 days ago", "version": "1.2", "size": "34MB", "pinned": False},
    {"name": "Dialogue Test 01", "modified": "Last week", "version": "1.0", "size": "12MB", "pinned": False},
    {"name": "Title Sequence", "modified": "Last month", "version": "2.1", "size": "89MB", "pinned": False}
]
...
class WelcomeWorkspace(BaseWorkspace):
    def __init__(self, app, parent=None):
        ...
        logo = QLabel("ZANIME")
        logo.setStyleSheet("font-size: 32px; font-weight: bold; color: #4CAF50; letter-spacing: 2px;")
        ...
        lbl_quick.setStyleSheet("font-size: 12px; font-weight: bold; color: #888; text-transform: uppercase;")
        ...
        lbl_demo.setStyleSheet("font-size: 12px; font-weight: bold; color: #888; text-transform: uppercase;")
        ...
        self.search_box.setStyleSheet("padding: 8px; border-radius: 4px; background-color: #2b2d36; border: 1px solid #3a3f4b; color: #fff;")
        ...
        links = ["Getting Started", "Documentation", "FAQ", "Keyboard Shortcuts", "Settings", "Exit"]
        for link in links:
            btn = QPushButton(link)
            btn.setCursor(Qt.PointingHandCursor)
            btn.setStyleSheet("border: none; color: #888; font-size: 12px; background: transparent; padding: 5px;")
    ...
    def _populate_projects(self):
        ...
        pinned_lbl.setStyleSheet("font-size: 11px; font-weight: bold; color: #666; text-transform: uppercase;")
        ...
        rec_lbl.setStyleSheet("font-size: 11px; font-weight: bold; color: #666; text-transform: uppercase;")
    ...
    def _open_demo(self):
        ...
        QMessageBox.information(self, "Demo Project", "The Crystal Forest demo project is currently downloading or unavailable.\n\nComing Soon!")
