...
from src.core.managers.release_manager import BackupManager, CrashReporter, UpdateManager, LicenseManager
...
class SettingsWorkspace(BaseWorkspace):
    ...
    def _sim_crash(self):
        ...
        self.host_widget.diag_log.setText(f"Report Generated for OS: {report.os_version}")
