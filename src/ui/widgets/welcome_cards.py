...
class ProjectCard(QFrame):
    ...
    def __init__(self, project_data, parent=None):
        ...
        name.setStyleSheet("font-weight: bold; font-size: 14px; color: #eee; background: transparent;")
        
        meta = QLabel(f"{project_data.get('modified', 'Unknown')} • v{project_data.get('version', '1.0')} • {project_data.get('size', '0MB')}")
...
class DemoProjectCard(QFrame):
    ...
    def __init__(self, parent=None):
        ...
        title.setStyleSheet("font-size: 18px; font-weight: bold; color: #4CAF50; background: transparent;")
        
        desc = QLabel("Explore a fully rigged, composited 2D scene demonstrating advanced ZANIME capabilities.")
        desc.setWordWrap(True)
        desc.setStyleSheet("color: #ccc; background: transparent; font-size: 13px; line-height: 1.4;")
        
        meta = QLabel("Estimated Load: 250MB • Coming Soon")
        meta.setStyleSheet("color: #888; font-size: 11px; background: transparent; margin-top: 10px;")
