...
class SplashScreen(QSplashScreen):
    def __init__(self, parent=None):
        ...
        self.title.setStyleSheet(
            "font-size: 42pt; font-weight: bold; color: #007acc; font-family: 'Segoe UI';"
        )
        self.title.setAlignment(Qt.AlignCenter)

        self.subtitle = QLabel("AI Powered 2D Animation Studio")
        self.subtitle.setStyleSheet(
            "font-size: 14pt; color: #e0e0e0; font-family: 'Segoe UI';"
        )
        self.subtitle.setAlignment(Qt.AlignCenter)

        self.loading_label = QLabel("Initializing...")
        self.loading_label.setStyleSheet(
            "font-size: 10pt; color: #aaaaaa; font-family: 'Segoe UI';"
        )
