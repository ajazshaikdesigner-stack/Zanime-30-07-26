...
from PySide6.QtWidgets import QVBoxLayout, QListWidget, QLineEdit, QComboBox, QHBoxLayout
...
class CharacterLibraryDock(BaseDock):
    def __init__(self, parent=None):
        ...
        self.category_combo.addItems([
            "All", "Kids", "Adults", "Animals", "Fantasy", 
            "Villains", "Robots", "Aliens", "Historical", "Mythology", "Crowd"
        ])
