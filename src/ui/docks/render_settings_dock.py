...
from PySide6.QtWidgets import QComboBox, QFormLayout, QPushButton, QVBoxLayout
...
class RenderSettingsDock(BaseDock):
    def __init__(self, parent=None):
        ...
        self.output_format.addItems(
            ["MP4 (H.264)", "MP4 (H.265)", "MOV", "AVI", "PNG Sequence"]
        )
        form.addRow("Format:", self.output_format)

        self.quality = QComboBox()
        self.quality.addItems(
            ["High Quality", "Preview", "Standard", "Draft", "Ultra Quality"]
        )
