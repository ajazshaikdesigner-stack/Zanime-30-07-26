...
from PySide6.QtWidgets import QVBoxLayout, QFormLayout, QComboBox, QTextEdit, QPushButton, QLabel
...
class StorySettingsDock(BaseDock):
    def __init__(self, parent=None):
        ...
        self.genre_combo.addItems([
            "Adventure", "Fantasy", "Comedy", "Drama", "Action",
            "Sci-Fi", "Mystery", "Educational", "Kids", "Horror", "Romance", "Custom"
        ])
        ...
        self.duration_combo.addItems(["Short (5 mins)", "Medium (15 mins)", "Long (30+ mins)"])
