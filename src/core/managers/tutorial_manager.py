...
from src.models.tutorial_model import TutorialStep, TutorialProgress, Achievement
...
class TutorialManager(QObject):
    ...
    def _build_steps(self) -> list[TutorialStep]:
        return [
            TutorialStep(0, "Welcome to Zanime", "Let's build 'The Crystal Forest'. Click Next to begin.", "Story"),
            TutorialStep(1, "Story Studio", "Here you write prompts. The AI will generate a story for Zehak.", "Story"),
            TutorialStep(2, "Character Studio", "Meet Zehak and Lumi. Here you manage their DNA and outfits.", "Characters"),
            TutorialStep(3, "World Builder", "This is the Crystal Forest environment.", "World"),
            TutorialStep(4, "Movie Composer", "Place characters into the scene using the timeline.", "SceneComposer"),
            TutorialStep(5, "Animation Director", "Add a walk cycle to Zehak.", "Animation"),
            TutorialStep(6, "Camera Director", "Frame the shot using the Rule of Thirds.", "Camera"),
            TutorialStep(7, "Voice Studio", "Generate dialogue for Zehak.", "Voice"),
            TutorialStep(8, "Production Renderer", "Render your 20-second movie!", "Renderer")
        ]
    ...
    def _init_achievements(self):
        self.progress.achievements = [
            ...
            Achievement("demo_complete", "Demo Completed", "Finished The Crystal Forest tutorial.")
        ]
    ...
    def _emit_state(self):
        ...
        self.progress_updated.emit(self.progress.current_step_index + 1, len(self.steps))
