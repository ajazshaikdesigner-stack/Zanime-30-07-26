...
class SceneValidator:
    @staticmethod
    def validate_shot(shot: ComposerShot, canvas_width=1920, canvas_height=1080) -> List[str]:
        errors = []
        ...
        for obj in shot.objects:
            ...
            if obj.x < -canvas_width or obj.x > canvas_width*2 or obj.y < -canvas_height or obj.y > canvas_height*2:
                errors.append(f"Out of Bounds: '{obj.name}' is placed way outside the camera frame.")
